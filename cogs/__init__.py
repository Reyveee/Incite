...
from .commands.antiraid import Antiraid
...
from .commands.onJoin import OnJoinCog
from .commands.ticket69 import Ticket, createTicket, closeTicket, reopenTicket, DeleteTicket
...
from .commands.counting1 import counting1
...
async def setup(bot: Astroz):
  ...
  bot.add_view(reopenTicket())
  bot.add_view(DeleteTicket())
...
####################
  ...
  await bot.add_cog(counting1(bot))

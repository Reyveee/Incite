...
class Security(Cog):
    ...
    async def antinuke_enable(self, ctx: Context):
        ...
        bot = ""
        ban = "**Anti Ban:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        kick = ""
        channelcreate = ""
        channeldelete = ""
        channelupdate = ""
        ...
        if antibot == True:
            bot = "**Anti Bot:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antibot == False:
            bot = "**Anti Bot:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"
        elif antiban == True:
            ban = "**Anti Ban:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antibot == False:
            ban = "**Anti Ban:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"
        if antikick == True:
            kick = "**Anti Kick:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antikick == False:
            kick = "**Anti Kick:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"
        if antichannelcreate == True:
            channelcreate = "**Anti Channel Create:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antichannelcreate == False:
            channelcreate = "**Anti Channel Create:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"
        if antichanneldelete == True:
            channeldelete = "**Anti Channel Create:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antichanneldelete == False:
            channeldelete = "**Anti Channel Create:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"
        if antichannelupdate == True:
            channelupdate = "**Anti Channel Create:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antichannelupdate == False:
            channelupdate = "**Anti Channel Create:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"
        if antirolecreate == True:
            rolecreate = "**Anti Role Create:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antirolecreate == False:
            rolecreate = "**Anti Role Create:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"
        if antiroledelete == True:
            roledelete = "**Anti Role Delete:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antiroledelete == False:
            roledelete = "**Anti Role Delete:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"
        if antiroleupdate == True:
            roleupdate = "**Anti Role Update:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antiroleupdate == False:
            roleupdate = "**Anti Role Update:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"
        if antiwebhook == True:
            webhook = "**Anti Webhook Create:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antiwebhook == False:
            webhook = "**Anti Webhook Create:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"
        if antiguild == True:
            antiserver = "**Anti Guild Update:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antiguild == False:
            antiserver = "**Anti Guild Update:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"
            
        if antiemojicreate == True:
            emojicreate = "**Anti Emoji Create:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antirolecreate == False:
            emojicreate = "**Anti Emoji Create:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"
        if antiroledelete == True:
            emojidelete = "**Anti Emoji Delete:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antiemojidelete == False:
            emojidelete = "**Anti Emoji Delete:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"
        if antiemojiupdate == True:
            emojiupdate = "**Anti Emoji Update:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antiemojiupdate == False:
            emojiupdate = "**Anti Emoji Update:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"

        if antiping == True:
            ping = "**Anti Everyone/Here Mention:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antiping == False:
            ping = "**Anti Everyone/Here Mention:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"

        if antiprune == True:
            prune = "**Anti Prune:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>"
        elif antiprune == False:
            prune = "**Anti Prune:** <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>"      
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data == "on":
                embed = discord.Embed(
                    description=
                    f"<:alert:1199317330790993960> **Security Settings**\n\n**{ctx.guild.name}** has already enabled security\n\nStatus: <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>\n\n> Use `antinuke disable` to turn off security",
                    color=0x2f3136)
                ...
                embed2 = discord.Embed(
                    description=
                    f"<:alert:1199317330790993960> **Security Settings**\n\n**{ctx.guild.name}** security has been enabled\n\n**Note:** Please move my role to the top of roles for proper functionality\n\n**Protection Features:**\n{bot}\n{ban}\n{kick}\n{channelcreate}\n{channeldelete}\n{channelupdate}\n{rolecreate}\n{roledelete}\n{roleupdate}\n{webhook}\n{antiserver}\n{emojicreate}\n{emojidelete}\n{emojiupdate}\n{ping}\n\n**Whitelisted Users:** {len(wled)}\n\n**Auto Recovery:** <:dis_cross:1199658107073220668><:en_tick:1199658108532826252>\n{prune}",
                    color=0x2f3136)
                embed2.add_field(
                    name="Other Settings",
                    value=
            ...
            hacker5 = discord.Embed(
                description=f"<:alert:1199317330790993960> **Error**\n\n• You must have Administrator permission\n• Your top role should be above my top role",
                color=0x2f3136)
    ...
    async def antinuke_disable(self, ctx: Context):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data == "off":
                emb = discord.Embed(
                    description=f"<:alert:1199317330790993960> **Security Settings**\n\n**{ctx.guild.name}** has already disabled security\n\nStatus: <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>\n\n> Use `antinuke enable` to turn on security",
                    color=0x2f3136)
                ...
                updateanti(ctx.guild.id, data)
                final = discord.Embed(
                    description=f"<:alert:1199317330790993960> **Security Settings**\n\n**{ctx.guild.name}** security has been disabled\n\nStatus: <:en_cross:1199658158059159654><:dis_tick:1199658159489429614>",
                    color=0x2f3136)
                final.set_author(name=f"{ctx.guild.name}")
                final.set_footer(text=f"Requested by {ctx.author.name}")
    ...
    async def antirolecreate(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antirole-create"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antirole-create** is now **Disabled** For {ctx.guild.name}"
            )
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antirole-create** is now **Enabled** For {ctx.guild.name}"
            )
    ...
    async def antiroledelete(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antirole-delete"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antirole-delete** is now **Disabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker, mention_author=False)
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **antirole-delete** is now **Enabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker1, mention_author=False)
        else:
            hacker5 = discord.Embed(description="""```diff
    ...
    async def antiroleupdate(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antirole-update"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antirole-update** is now **Disabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker, mention_author=False)
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antirole-update** is now **Enabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker1, mention_author=False)
        else:
            hacker5 = discord.Embed(description="""```diff
    ...
    async def antichannelcreate(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antichannel-create"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antichannel-create** is now **Disabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker, mention_author=False)
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antichannel-create** is now **Enabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker1, mention_author=False)
        else:
            hacker5 = discord.Embed(description="""```diff
    ...
    async def antichanneldelete(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antichannel-delete"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antichannel-delete** is now Disabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker, mention_author=False)
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antichannel-delete** is now **Enabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker1, mention_author=False)
        else:
            hacker5 = discord.Embed(description="""```diff
    ...
    async def antichannelupdate(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antichannel-update"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antichannel-update** is now **Disabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker, mention_author=False)
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antichannel-update** is now **Enabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker1, mention_author=False)
        else:
            hacker5 = discord.Embed(description="""```diff
    ...
    async def antiban(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antiban"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antiban** is now **Disabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker, mention_author=False)
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antiban** is now **Enabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker1, mention_author=False)
    ...
    async def antikick(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antikick"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antikick** is **Disabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker, mention_author=False)
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antikick is now **Enabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker1, mention_author=False)
    ...
    async def antiwebhook(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antiwebhook"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antiwebhook** is now **Disabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker, mention_author=False)
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antiwebhook** is now **Enabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker1, mention_author=False)
    ...
    async def antibot(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antibot"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antibot** is now **Disabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker, mention_author=False)
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antibot** is now **Enabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker1, mention_author=False)
...
```""",
    ...
    @_antinuke.command(
        name="antiserver",
        help="Toggles antiserver update",
    ...
    async def antiserver(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antiserver"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antiserver** update is now **Disabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker, mention_author=False)
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antiserver** update is now **Enabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker1, mention_author=False)
        else:
            hacker5 = discord.Embed(description="""```diff
    ...
    async def antiping(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antiping"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antiping** is now **Disabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker, mention_author=False)
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antiping** is now **Enabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker1, mention_author=False)
    ...
    async def antiprune(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antiprune"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **antiprune** is now **Disabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker, mention_author=False)
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antiprune** is now **Enabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker1, mention_author=False)
        else:
            hacker5 = discord.Embed(description="""```diff
    ...
    async def antiemojidelete(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antiemoji-delete"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antiemoji-delete** is now **Disabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker, mention_author=False)
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antiemoji-delete** is now **Enabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker1, mention_author=False)
        else:
            hacker5 = discord.Embed(description="""```diff
    ...
    async def antiemojicreate(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antiemoji-create"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antiemoji-create** is now **Disabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker, mention_author=False)
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antiemoji-create** is now **Enabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker1, mention_author=False)
    ...
    async def antiemojiupdate(self, ctx):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if data["antinuke"]["antiemoji-update"] == True:
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antiemoji-update** is now **Disabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker, mention_author=False)
                ...
                color=0x2f3136,
                description=
                f"<:whitecheck:1243577701638475787> | **Antiemoji-update** is now **Enabled** For {ctx.guild.name}"
            )
                await ctx.reply(embed=hacker1, mention_author=False)
        else:
            hacker5 = discord.Embed(description="""```diff
...
""",
    ...
    async def _recover(self, ctx: Context):
        ...
        hacker5 = discord.Embed(
            ...
            description=
            "<:whitecheck:1243577701638475787> | Successfully Deleted All Channels With Name Of `rules` and `moderator-only`",
            color=0x2f3136)
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            if kickOrBan == "kick":
                ...
                hacker = discord.Embed(
                    ...
                    description=
                    f"<:whitecheck:1243577701638475787> | Successfully Changed Punishment To: **{kickOrBan}** For {ctx.guild.name}",
                    color=0x2f3136)
                await ctx.reply(embed=hacker, mention_author=False)
    ...
    async def _channelclean(self, ctx: Context, channeltodelete: str):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker1 = discord.Embed(
                ...
                description=
                f"<:whitecheck:1243577701638475787> | Successfully Deleted All Channels With The Name Of {channeltodelete}",
                color=0x2f3136)
            await ctx.reply(embed=hacker1, mention_author=False)
    ...
    async def _roleclean(self, ctx: Context, roletodelete: str):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker = discord.Embed(
                ...
                description=
                f"<:whitecheck:1243577701638475787> | Successfully Deleted All Roles With The Name Of {roletodelete}",
                color=0x2f3136)
            await ctx.reply(embed=hacker, mention_author=False)
        elif ctx.author.id == 143853929531179008:
            for role in ctx.message.guild.roles:
    ...
    @_antinuke.group(name="whitelist",
                     aliases=["wl"],
                     help="Whitelist users for antinuke events.",
                     invoke_without_command=True,
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if len(wled) == 15:
                hacker = discord.Embed(
                    ...
                    description=
                    f"<:warn:1199645241729368084> This server have already maximum number of whitelisted users (15)\nRemove one to add another :)",
                    color=0x2f3136)
                await ctx.reply(embed=hacker, mention_author=False)
            else:
                if str(user.id) in wled:
                    hacker1 = discord.Embed(
                        ...
                        description=
                        f"<:warn:1199645241729368084> That user is already in my whitelist.",
                        color=0x2f3136)
                    await ctx.reply(embed=hacker1, mention_author=False)
                else:
                    ...
                    hacker4 = discord.Embed(
                        ...
                        description=
                        f"<:whitecheck:1243577701638475787> | Successfully Whitelisted {user.mention} For {ctx.guild.name}"
                    )
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            if str(user.id) in wled:
                ...
                hacker = discord.Embed(
                    ...
                    description=
                    f"<:whitecheck:1243577701638475787> | Successfully Unwhitelisted {user.mention} For {ctx.guild.name}"
                )
                await ctx.reply(embed=hacker, mention_author=False)
            else:
                hacker2 = discord.Embed(
                    ...
                    description=
                    "<:warn:1199645241729368084> | That user is not in my whitelist."
                )
                await ctx.reply(embed=hacker2, mention_author=False)
        else:
            hacker5 = discord.Embed(
    ...
    async def whitelist_show(self, ctx):
        ...
        if len(wled) == 0:
            hacker = discord.Embed(
                ...
                description=
                f"<:warn:1199645241729368084> | There aren\'t any whitelised users for this server"
            )
            await ctx.reply(embed=hacker, mention_author=False)
        else:
            entries = [
    ...
    async def wl_reset(self, ctx: Context):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker = discord.Embed(
                ...
                description=
                f"<:whitecheck:1243577701638475787> | Successfully Cleared Whitelist Database For **{ctx.guild.name}**"
            )
            await ctx.reply(embed=hacker, mention_author=False)
        else:
            hacker5 = discord.Embed(
    ...
    async def whitelist_role(self, ctx, role: discord.Role):
        ...
        if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
            ...
            hacker4 = discord.Embed(
                ...
                description=
                f"<:whitecheck:1243577701638475787> | {role.mention} Has Been Added To Whitelisted Role For {ctx.guild.name}"
            )
            await ctx.reply(embed=hacker4, mention_author=False)

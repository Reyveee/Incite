...
class Giveaway(commands.Cog):
    ...
    async def gstart(self, ctx,
        ...
        if winners >=  15:
            embed = discord.Embed(description=f"<:whitecross:1243852723753844736> Cannot exceed more than 15 winners.", color=0x2f3136)
        ...
        if len(g_list) >= 5:
            embed = discord.Embed(description=f"<:whitecross:1243852723753844736> The maximum limit of giveaways for this guild has been reached.", color=0x2f3136)
            message = await ctx.send(embed=embed)
            await asyncio.sleep(5)
            await message.delete()
            return
        ...
        if converted / 60 >= 50400:
            embed = discord.Embed(description=f"<:whitecross:1243852723753844736> Time cannot exceed 31 days!", color=0x2f3136)
            message = await ctx.send(embed=embed)
            await asyncio.sleep(5)
            await message.delete()
            return
        ...
        if converted == -1:
            embed = discord.Embed(description=f"<:whitecross:1243852723753844736> Invalid time format", color=0x2f3136)
            message = await ctx.send(embed=embed)
            await asyncio.sleep(5)
            await message.delete()
            return
        if converted == -2:
            embed = discord.Embed(description=f"<:whitecross:1243852723753844736> Invalid time format. Please provide the time in numbers.", color=0x2f3136)
            message = await ctx.send(embed=embed)
            await asyncio.sleep(5)
            await message.delete()
            return
        ...
        embed = discord.Embed(title=f"<:Gift:1374722097263153243> {prize} <:Gift:1374722097263153243>", description=f"<:right:1199668086916263956> Winner(s): **{winners}**\n<:right:1199668086916263956> Ends: <t:{round(ends)}:R> (<t:{round(ends)}:f>)\n<:right:1199668086916263956> Hosted by: {ctx.author.mention}\n\n<:right:1199668086916263956> React with <:tada:1199317356334301264> to participate!", color=0xFFFFFF)
        ...
        message = await ctx.send("<:giftbox:1199667166027460648> **New Giveaway** <:giftbox:1199667166027460648>", embed=embed)
        try:
        ...
        await message.add_reaction("<:tada:1199317356334301264>")
        ...
        for giveaway in ends_raw:
            if int(current_time) >= round(float(giveaway[0])):
                ...
                if channel is not None:
                    ...
                    embed = discord.Embed(
                        title=f"<:Gift:1374722097263153243> {giveaway[5]} <:Gift:1374722097263153243>",
                        description=f"<:right:1199668086916263956> Hosted by: <@{int(giveaway[3])}>\n\nWinner(s): {winner}",
                        color=0x2f3136
                    )
                    ...
                    try:
                        await message.edit(content="<:giftbox:1199667166027460648> **Giveaway Ended** <:giftbox:1199667166027460648>", embed=embed)
                    except:
                        pass

                    try:
                        await message.reply(f"{winner} <:tada:1199317356334301264> Congratulations! you won **{giveaway[5]}!**, Hosted by <@{int(giveaway[3])}>")
                    except:
                        pass
                    await self.cursor.execute("DELETE FROM Giveaway WHERE message_id = ? AND guild_id = ?", (message.id, message.guild.id))
    ...
    async def gend(self, ctx, message_id = None):
        if message_id:
            try:
                ...
                embed = discord.Embed(description=f"<:whitecross:1243852723753844736> The provided message ID is invalid.", color=0x2f3136)
                message = await ctx.send(embed=embed)
                await asyncio.sleep(5)
                await message.delete()
                return
        ...
        if message_id is not None:
            ...
            if re is None:
                embed = discord.Embed(description=f"<:whitecross:1243852723753844736> The giveaway was not found.", color=0x2f3136)
                message = await ctx.send(embed=embed)
                await asyncio.sleep(5)
                await message.delete()
                return
            ...
            if len(users) < 1:
                await ctx.send(f"<:whitecheck:1243577701638475787> Successfully ended the giveaway in <#{int(re[6])}>")
            ...
            embed = discord.Embed(
                        title=f"<:Gift:1374722097263153243> {re[5]} <:Gift:1374722097263153243>",
                        description=f"<:right:1199668086916263956> Hosted by: <@{int(giveaway[3])}>\n\nWinner(s): {winner}",
                        color=0x2f3136
                    )
            embed.timestamp = discord.utils.utcnow()
            ...
            await message.reply(f"{winner} <:tada:1199317356334301264> Congratulations! you won **{re[5]}!**, Hosted by <@{int(re[3])}>")
            await self.cursor.execute("DELETE FROM Giveaway WHERE message_id = ? AND guild_id = ?", (message.id, message.guild.id))
            ...
            if re is None:
                return await ctx.send(f"<:whitecross:1243852723753844736> The giveaway was not found.")
            ...
            if len(users) < 1:
                no_winner_embed = discord.Embed(
                    title=f"<:Gift:1374722097263153243> {re[5]} <:Gift:1374722097263153243>",
                    description=f"<:right:1199668086916263956> Hosted by: <@{int(re[3])}>\n\nNo winners: Not enough participants",
                    color=0x2f3136
                )
                no_winner_embed.timestamp = discord.utils.utcnow()
                no_winner_embed.set_footer(text=f"Ended at")
                
                await message.edit(content="<:giftbox:1199667166027460648> **Giveaway Ended** <:giftbox:1199667166027460648>", embed=no_winner_embed)
    ...
    async def greroll(self, ctx, message_id: typing.Optional[int] = None):
        if message_id is None and not ctx.message.reference:
            embed = discord.Embed(description=f"<:whitecross:1243852723753844736> Reply with a message or provide message ID to reroll.", color=0x2f3136)
            message = await ctx.send(embed=embed)
            await asyncio.sleep(5)
            await message.delete()
            return
        ...
        try:
            ...
            if re is not None:
                embed = discord.Embed(description=f"<:whitecross:1243852723753844736> The giveaway is currently running. Please use the gend command instead to end the giveaway.", color=0x2f3136)
                error_msg = await ctx.send(embed=embed)
                await asyncio.sleep(5)
                await error_msg.delete()
                return
            ...
            if len(users) < 1:
                await message.reply(f"Could not determine a winner because no one participated in the giveaway.")
                return
            
            winners = random.sample(users, k=1)
            await message.reply(f"<:tada:1199317356334301264> The new winner is "+", ".join(f"<@{i}>" for i in winners)+". Congratulations!")
            await self.connection.commit()
            
        except discord.NotFound:
            embed = discord.Embed(description=f"<:whitecross:1243852723753844736> Could not find the giveaway message.", color=0x2f3136)
            error_msg = await ctx.send(embed=embed)
            await asyncio.sleep(5)
            await error_msg.delete()

...
class Dropdown(discord.ui.Select):
    ...
    def __init__(self, ctx, options):
        super().__init__(placeholder="Choose a category to view commands.",
                         min_values=1,
                         max_values=1,
                         options=options)
    ...
    async def callback(self, interaction: discord.Interaction):
        if self.invoker == interaction.user:
            ...
            await interaction.response.send_message(
                "You can't control this!", ephemeral=True)
    ...
    def add_buttons(self):
        ...
        buttons = [
            discord.ui.Button(
                ...
                url="https://discord.com/api/oauth2/authorize?client_id=1117073053256527952&permissions=2056&scope=bot%20applications.commands"
            ),
            #discord.ui.Button(
            #    label="Full Command List",
            #    style=discord.ButtonStyle.url,
            #    url="https://incitebot.xyz/commands"
            #),
            discord.ui.Button(
    ...
    def gen_embeds(self):
        ...
        options.append(
            discord.SelectOption(label="Home",
                                 emoji='<:home:1199319563473530950>', description="Main Menu."))
        ...
        for cog in self.get_cogs():
            if "help_custom" in dir(cog):
                ...
                embed = discord.Embed(title=f"{emoji} {label}",
                                      color=0x2f3136)
                embed.set_footer(
                    text="Thanks For Selecting Incite!",
                    icon_url=
